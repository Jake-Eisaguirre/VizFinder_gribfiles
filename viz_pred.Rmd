...
# https://nomads.ncep.noaa.gov/cgi-bin/filter_gfswave.pl?file=gfswave.t18z.wcoast.0p16.f000.grib2&lev_surface=on&var_DIRPW=on&var_HTSGW=on&var_PERPW=on&var_WIND=on&subregion=&leftlon=240.333&rightlon=240.333&toplat=34.16667&bottomlat=34.16667&dir=%2Fgfs.20220620%2F18%2Fwave%2Fgridded

direction <- vector("list", length(mod.list))

unlink(here("direction/*"))
for(i in seq_along(mod.list)) {
  url_dcomp <- paste0("https://nomads.ncep.noaa.gov/cgi-bin/filter_gfswave.pl?file=gfswave.t" , mod_time, "z.wcoast.0p16.f", mod.list[[1]] ,".grib2&lev_surface=on&var_DIRPW=on&var_HTSGW=on&var_PERPW=on&var_WIND=on&subregion=&leftlon=240.333&rightlon=240.333&toplat=34.16667&bottomlat=34.16667&dir=%2Fgfs.", date ,"%2F" , mod_time, "%2Fwave%2Fgridded")
